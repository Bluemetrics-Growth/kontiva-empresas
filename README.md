...
- `public/`: `favicon.svg`, telas reais em `public/images/telas/`, `og/og.png`, logos em `public/assets/`. As fotos de hero antigas continuam em `public/images/` mas não são mais usadas.
...
- Hero sem foto: a dor do crédito aparece desenhada (cadeia Compra, Pagamento, Recolhimento, Crédito). É a única animação da página e respeita `prefers-reduced-motion`.
